 ...
 * @param[in] routes_vpn_prefix       The prefix of VPN interface, netmask length (also called a prefix).
 ...
 * @param[in] routes_orig_prefix      The prefix of Original interface, netmask length (also called a prefix).
