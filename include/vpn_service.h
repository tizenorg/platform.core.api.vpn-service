 ...
 * @since_tizen 3.0
 * @param[in] handle The VPN tun interface handle
 * @param[out] fd The fd of VPN tun fd
 ...
 * @since_tizen 3.0
 * @param[in] handle The VPN tun interface handle
 * @param[out] index The index of VPN tun index
 ...
 * @see vpnsvc_init()
 */
API int vpnsvc_set_session_name(vpnsvc_tun_h handle, const char* session_name);
 ...
 * @see vpnsvc_init()
 */
API int vpnsvc_get_session_name(vpnsvc_tun_h handle, char* session_name);
